      ...
      <main className="flex-grow pt-28 pb-16">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-foreground/70">Here's what's happening with your business account today.</p>
          </motion.div>
          ...
          >
            <div className="bg-white rounded-xl shadow-card border border-border/30 p-5">
              ...
              <div className="flex justify-between items-end">
                ...
                <Link to="/business/campaigns" className="text-sm text-primary flex items-center">
                  <span>View all</span>
            ...
            <div className="bg-white rounded-xl shadow-card border border-border/30 p-5">
              ...
              <div className="flex justify-between items-end">
                ...
                <Link to="/business/messages" className="text-sm text-blue-600 flex items-center">
            ...
            <div className="bg-white rounded-xl shadow-card border border-border/30 p-5">
              ...
              <div className="flex justify-between items-end">
                ...
                <Link to="/business/budget" className="text-sm text-green-600 flex items-center">
                  <span>Manage</span>
                  <ChevronRight size={16} />
                </Link>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-card border border-border/30 p-5">
              ...
              <div className="flex justify-between items-end">
                ...
                <Link to="/business/influencers/pending" className="text-sm text-purple-600 flex items-center">
                  <span>Review</span>
                  <ChevronRight size={16} />
                </Link>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-card border border-border/30 p-5">
              <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4">
                <div className="flex-grow relative">
                  ...
                  <input
                    type="text"
                    className="input-primary pl-10 w-full py-3"
                    placeholder="Search for influencers by name, category, or location..."
                  />
                </div>
                <button className="flex items-center justify-center gap-2 bg-secondary text-foreground font-medium py-3 px-5 rounded-md hover:bg-secondary/70 transition-colors">
                  <Filter size={18} />
                  <span>Filters</span>
                </button>
                <button className="flex items-center justify-center bg-primary text-white font-medium py-3 px-5 rounded-md hover:bg-primary/90 transition-colors">
                  Find Influencers
                </button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-white rounded-xl shadow-card border border-border/30 overflow-hidden">
                <div className="flex justify-between items-center p-5 border-b border-border/30">
                  ...
                  <Link to="/business/influencers" className="text-sm text-primary flex items-center">
                    <span>View all</span>
                    <ChevronRight size={16} />
                  </Link>
                </div>
                ...
                <div className="divide-y divide-border/30">
                  {mockData.recentInfluencers.map((influencer) => (
                    <div key={influencer.id} className="p-5 hover:bg-secondary/30 transition-colors">
                        ...
                        <div className="flex-grow">
                          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                            <div>
                              ...
                              <p className="text-sm text-foreground/70">{influencer.category}</p>
                            </div>
                            <span className="text-sm font-medium bg-primary/10 text-primary px-2 py-0.5 rounded-full mt-1 sm:mt-0 inline-flex items-center">
                          ...
                          <div className="flex flex-wrap gap-x-4 gap-y-2 mt-3">
                            <div className="flex items-center">
                              <Users size={14} className="text-foreground/60 mr-1" />
                              <span className="text-sm">{influencer.followers}</span>
                            </div>
                            <div className="flex items-center">
                              <TrendingUp size={14} className="text-foreground/60 mr-1" />
            ...
            >
              ...
              <div className="bg-white rounded-xl shadow-card border border-border/30 overflow-hidden mb-6">
                <div className="flex justify-between items-center p-5 border-b border-border/30">
                  <h2 className="text-xl font-semibold">Campaign Performance</h2>
                  <Link to="/business/analytics" className="text-sm text-primary flex items-center">
                    <span>Details</span>
                    <ChevronRight size={16} />
                  </Link>
                </div>
                ...
                <div className="p-5 grid grid-cols-2 gap-4">
                  <div className="p-3 bg-secondary/30 rounded-lg">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm text-foreground/70">Impressions</span>
              ...
              <div className="bg-white rounded-xl shadow-card border border-border/30 overflow-hidden">
                <div className="flex justify-between items-center p-5 border-b border-border/30">
                  ...
                  <Link to="/business/campaigns/calendar" className="text-sm text-primary flex items-center">
                    <span>Calendar</span>
                    <ChevronRight size={16} />
                  </Link>
                </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center">
                              <DollarSign size={14} className="text-foreground/60 mr-1" />
                ...
                <div className="p-5 bg-secondary/30 border-t border-border/30">
                  <Link 
                    ...
                    className="block w-full py-2.5 text-center text-primary font-medium bg-white border border-primary/30 rounded-md hover:bg-primary/5 transition-colors"
                  >
                    Create New Campaign
                  </Link>
                </div>
